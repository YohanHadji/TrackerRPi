...
def sendTargetToColimator(pointToSendIn):
   ...
   #  s2 = 1468.0770404111263 + (0.01674877 * pointToSendIn.x) + (0.89634829 * pointToSendIn.y)
    ...
    # ojo la calibracion de abajo puede pertenecer a l tracker de argentina 
    ...
    # x2 = round(x2, 3)
    # y2 = round(y2, 3)
    s1 = 1492.080644240122 + (-0.00785081 * pointToSendIn.x) + ( -1.06954105 * pointToSendIn.y)
    s2 = 1489.9933463522896 + (-0.90589319 * pointToSendIn.x) + (0.00446447 * pointToSendIn.y)
