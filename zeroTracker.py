    ...
    while True:
        ...
        if (not firstTimeNoted):
            ...
            while (numberOfFrames < 500):
                frame, sensorTimeStamp = getFrame('old')
            ...
            if (newPacketReceived()):
                ...
                if (packetType == "controller"):
                    ...
                    setCameraSettings('old',cameraSetting["gain"], cameraSetting["exposureTime"])
...
def update_variable():
    ...
    if control_id in input_values:
        ...
        setCameraSettings('old',input_values["gain"], input_values["exposureTime"])
